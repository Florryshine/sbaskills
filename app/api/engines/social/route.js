...
{
  "posts": [
    { "platform": "instagram", "caption": "🌿 Did you know? Photosynthesis is how plants make their own food! ... 📚 Learn more at Shiney Brain Academy #Photosynthesis #Biology" }
  ]
}
...
export async function POST(request) {
  try {
    ...
    // 4. Insert each post as a separate row in social_post_drafts
