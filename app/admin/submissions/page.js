  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 shadow-sm border">
        <p className="text-xs font-bold uppercase tracking-widest text-brand-yellow">Manage Submissions</p>
        <h1 className="text-2xl font-extrabold text-brand-blue mt-1">All Submissions</h1>
        <p className="text-sm text-gray-500">{submissions.length} submissions total</p>
      </div>
