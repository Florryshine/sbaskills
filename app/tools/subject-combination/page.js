...
const courseData = {
  'Medicine': {
    ...
    schools: 'UNILAG, UNIBEN, OAU, UI, ABU, UNN',
  },
  'Nursing': {
    ...
    schools: 'UNILAG, UNIBEN, OAU, UI, UNN, ABU',
  },
  'Pharmacy': {
    subjects: ['English Language', 'Biology', 'Chemistry', 'Physics'],
  ...
  'Engineering': {
    ...
    schools: 'UNILAG, UNIBEN, OAU, UI, FUTA, UNN, ABU',
  },
  'Computer Science': {
  ...
  'Agriculture': {
    ...
    schools: 'UNILAG, UNIBEN, OAU, UI, UNN, ABU, FUTA',
  },
  'Geology': {
...
export default function SubjectCombinationChecker() {
