...
export default function AdmissionChanceChecker() {
  ...
  // Fetch schools and courses on load
  useEffect(() => {
  ...
  // Filter courses when school is selected
  useEffect(() => {
    if (formData.school) {
  ...
  const calculateChance = async () => {
    ...
    // Get cutoff for selected school + course
