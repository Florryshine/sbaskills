 ...
 * and an instagram_caption (the feed caption + hashtags). Kept separate so
 * "regenerate only the caption" doesn't touch the carousel slide copy.
 */
  ...
  return [
    {
      ...
      title: asset.keyword,
      body: null,
      metadata: { slides: carousel.slides || [] },
    },
    {
