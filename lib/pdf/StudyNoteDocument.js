...
const styles = StyleSheet.create({
  h1: { fontSize: 20, fontFamily: 'Helvetica-Bold', color: brand.colors.primary, marginTop: 14, marginBottom: 8 },
  h2: { fontSize: 15, fontFamily: 'Helvetica-Bold', color: brand.colors.primary, marginTop: 12, marginBottom: 6, borderBottomWidth: 1, borderBottomColor: brand.colors.secondary, paddingBottom: 3 },
  ...
  bullet: { width: 12, color: brand.colors.secondary, fontFamily: 'Helvetica-Bold' },
  listText: { flex: 1, lineHeight: 1.4 },
  table: { marginBottom: 10, borderWidth: 1, borderColor: '#ccc' },
  tableRow: { flexDirection: 'row' },
  tableCellHeader: { flex: 1, backgroundColor: brand.colors.primary, color: '#fff', fontSize: 9.5, fontFamily: 'Helvetica-Bold', padding: 5, borderRightWidth: 1, borderRightColor: '#fff' },
...
export default function StudyNoteDocument({ title, keyword, markdown }) {
