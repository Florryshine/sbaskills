  ...
  return [
    {
      ...
      // X posts read fine as text-only, but an attached image measurably
      // improves reach — attach one, format stays 'text' since the caption
      // is still the primary payload.
      _media: {
        type: 'hero_image',
