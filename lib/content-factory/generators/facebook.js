...
- Immediately after that question, add ONE short, casual follow line in the same voice — e.g. "Follow for daily JAMB tips" or "Hit follow so you don't miss the next one" — NOT a separate corporate-sounding CTA, just one more sentence in the same energy as the rest of the post.
...
{ "caption": "...", "hashtags": ["#tag1", "#tag2"] }`;
  ...
  return [
    ...
    {
      // Hero-image variant: same caption, single branded photo instead of a
      // carousel — a quicker post option and a fallback if the carousel
      // render fails.
      asset_type: 'facebook_hero',
      platform: 'facebook',
      format: 'image',
      title: asset.keyword,
      body: data.caption,
      ...
      _media: {
        ...
        preset: 'hero', // 1200x675 landscape — matches Facebook's feed image ratio
      },
    },
  ];
}
