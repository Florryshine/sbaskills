...
{ "caption": "...", "hashtags": ["#tag1", "#tag2"] }`;
  ...
  return [
    ...
    },
    {
      ...
      // "document" carousel — a quicker post option and a fallback if the
      // carousel render fails.
      asset_type: 'linkedin_hero',
      platform: 'linkedin',
      format: 'image',
      title: asset.keyword,
      body: data.caption,
      ...
      _media: {
        ...
        preset: 'hero', // 1200x675 landscape — matches LinkedIn's feed image ratio
      },
    },
  ];
}
