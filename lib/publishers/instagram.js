...
async function finishPublish(igUserId, token, creationId, isVideo) {
  // Video containers need a moment to process before they're publishable.
  if (isVideo) await pollUntilReady(igUserId, token, creationId);
